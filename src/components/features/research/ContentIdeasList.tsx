...
export function ContentIdeasList() {
  ...
  if (loading) {
    return <div className="py-12 text-center text-[13px] text-slate-500">Loading content ideas...</div>
  }

  if (!ideas.length && !undoData) {
    return <div className="py-12 text-center text-[13px] text-slate-500">No content ideas scored yet.</div>
  }
